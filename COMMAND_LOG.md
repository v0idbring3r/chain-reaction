...
29. `npx expo install @react-native-async-storage/async-storage` — Install AsyncStorage for settings persistence
30. `npx expo install expo-audio` — Install expo-audio (replacement for deprecated expo-av)
